...
import { AdultZoneMobileNav } from "../AdultZone/AdultZoneMobileNav";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/user/:userId" element={isAuthenticated ? (isProfileComplete() ? <PublicProfileView /> : <Navigate to="/profile" replace />) : <Navigate to="/profile" replace />} />
