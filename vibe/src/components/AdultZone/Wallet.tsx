        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <button onClick={() => navigate('/adult/settings#push-notifications')} className="px-5 py-2.5 rounded-full bg-[var(--az-accent-primary)] hover:bg-[var(--az-accent-rose)] text-white text-[10px] font-bold uppercase tracking-widest transition-all active:scale-95">Test Push Notifications</button>
