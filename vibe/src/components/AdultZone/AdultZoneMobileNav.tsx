...
export const AdultZoneMobileNav: React.FC = () => {
  ...
  return (
    <nav data-testid="bottom-tab-bar" className="md:hidden fixed inset-x-0 bottom-0 z-[100] border-t border-[var(--az-border)] bg-[var(--az-bg-secondary)]" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
