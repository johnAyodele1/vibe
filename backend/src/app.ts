...
const allowedOrigins = process.env.ALLOWED_ORIGINS
  ...
  : [process.env.FRONTEND_URL || 'https://zippo-r8hk.onrender.com', process.env.FRONTEND_DATING_URL || 'http://localhost:3000', process.env.FRONTEND_ADULT_URL || 'http://localhost:3001', 'http://localhost:5173'];
