...
import { adminLogin, getAnalytics, getAllReports, getAllUsers, adminAction, getViolations, updateViolationAction, getAdminDiamondRate, updateAdminDiamondRate, getDailyUsers, getDailyEarnings, getEarningsBreakdown, getTopProviders, getUserRetention, getRecentTransactions } from '../controllers/admin.controller';
...
import { adminGetAds, adminCreateAd, adminUpdateAd, adminUpdateAdStatus, adminDeleteAd, adminUploadMedia } from '../controllers/advertisement.controller';
import { adminCreateNotification, adminGetNotifications, adminGetSupportQueue, adminGetSupportMessages, adminReplySupportMessage, adminManageSupportTags, updateOfficialChannelsConfig, getOfficialChannelsConfig, adminUploadChannelAvatar } from '../controllers/officialSupport.controller';
