...
import { getWallet, getBundles, getTransactions, initializePurchase, verifyPurchase, handlePaystackWebhook, createPurchaseIntent, simulateWebhookSuccess, getSubscriptionPlans, directTip, getDiamondRate } from '../controllers/wallet.controller';
...
import { getTicketAvailability, purchaseTickets, createTicketOrder, verifyTicketOrder, getMyTickets, getTicketByCode, scanCheckinQuery, performCheckinScan, getCheckinDashboard } from '../controllers/ticket.controller';
...
router.post('/adult/push/health-test/ack', acknowledgePushHealthTest);
router.get('/adult/push/health-test/status', verifyAdultJWT, getPushHealthTestStatus);
router.post('/adult/push/health', verifyAdultJWT, markPushHealth);
...
router.post('/adult/wallet/paystack/initialize', verifyAdultJWT, initializePurchase);
router.get('/adult/wallet/paystack/verify/:reference', verifyAdultJWT, verifyPurchase);
router.post('/adult/wallet/paystack/webhook', handlePaystackWebhook);
...
router.post('/adult/auth/deactivate', verifyAdultJWT, deactivateAccount);
...
router.get('/adult/providers/:providerId', verifyAdultJWT, getPublicProviderProfileWithResponseStats);
...
router.post('/parties/:partyId/tickets/orders', verifyAdultJWT, createTicketOrder);
router.post('/parties/orders/:orderId/verify', verifyAdultJWT, verifyTicketOrder);
