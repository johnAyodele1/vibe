  ...
  try {
    ...
    const defaultRooms = [
      ...
      },
      {
        ...
        description: 'Friendly chats and relaxed discussions',
        category: 'chat',
        mood: 'chill',
        memberCount: 890,
        icon: '☕',
      ...
      {
        name: 'Movie & Popcorn',
        description: 'Discuss your favorite films and series',
        category: 'movies',
        mood: 'chill',
        memberCount: 120,
        icon: '🎬',
      ...
      {
        name: 'Music & Vibes',
        description: 'Share tracks, playlists, and recommendations',
        category: 'music',
        mood: 'chill',
        memberCount: 560,
        icon: '🎵',
